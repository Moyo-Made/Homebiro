	...
	return (
		<section id="waitlist" className="flex flex-col justify-center items-center font-dmsans mt-16">
			<div className="flex flex-col justify-center items-center">
				...
				<p className="md:w-[800px] w-[350px] text-[#222222] font-light text-center">
			...
			<div className="relative flex gap-3 mt-6">
				...
				<input
					...
					className="md:w-[500px] w-[350px] h-[50px] border border-[#164CA4] rounded-md pl-14 focus:outline-[#31558fd2] placeholder:text-[#222222] placeholder:font-light"
					required
				/>
			</div>
			...
			<div className="mt-10">
				<Link
					href="/join-now"
					className="md:px-[215px] px-[140px] py-3 bg-[#164CA4] text-white text-center rounded-md hover:bg-[#0E3A8B]"
				>
					Join Now
				</Link>
			</div>
